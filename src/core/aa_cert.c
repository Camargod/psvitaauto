...
/*
 * Google Automotive Link client certificate and private key, vendored from
 * aasdk (f1xpl/aasdk, src/Messenger/Cryptor.cpp), GPL-3.0.
 * The phone's head-unit server accepts this fixed identity in practice.
 */
const char *aa_cert_pem(void) {
    return
        "-----BEGIN CERTIFICATE-----\n"
