 ...
 */
/* PSVitaAuto: ASM re-enabled to speed up the RSA handshake. */
 ...
 */
/* PSVitaAuto: disabled — we use our own transport, not mbedtls net_sockets. */
 ...
 */
/* PSVitaAuto: disabled — timing is Unix/Windows-only and unused for TLS 1.2. */
